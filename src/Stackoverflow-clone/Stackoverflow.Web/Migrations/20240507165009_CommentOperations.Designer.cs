...
namespace Stackoverflow.Web.Migrations
{
    ...
    [Migration("20240507165009_CommentOperations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stackoverflow.Domain.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5048),
                            Downvotes = 2,
                            IsDeleted = false,
                            LastModifiedDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5061),
                            PostType = 0,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5065),
                            Downvotes = 1,
                            IsDeleted = false,
                            LastModifiedDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5066),
                            PostType = 1,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5075),
                            Downvotes = 3,
                            IsDeleted = false,
                            LastModifiedDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5076),
                            PostType = 0,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5079),
                            Downvotes = 0,
                            IsDeleted = false,
                            LastModifiedDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5079),
                            PostType = 1,
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5082),
                            Downvotes = 1,
                            IsDeleted = false,
                            LastModifiedDate = new DateTime(2024, 5, 7, 22, 50, 9, 463, DateTimeKind.Local).AddTicks(5083),
                            PostType = 0,
            ...
            modelBuilder.Entity("Stackoverflow.Domain.Entities.PostAndComment", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PostAndComments", (string)null);
                });
            ...
            modelBuilder.Entity("Stackoverflow.Domain.Entities.UserBadge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Stackoverflow.Infrastructure.Membership.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a1f7777a-6530-4fee-6f5a-08dc5edbc664"),
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("16f53ba8-f8fd-4cf6-6f5b-08dc5edbc664"),
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = new Guid("244902a4-a09b-410d-6f5c-08dc5edbc664"),
                            Name = "Newbie",
                            NormalizedName = "NEWBIE"
                        },
                        new
                        {
                            Id = new Guid("4b78faf4-752b-4806-6f5d-08dc5edbc664"),
                            Name = "Elite",
                            NormalizedName = "ELITE"
                        },
                        new
                        {
                            Id = new Guid("2f0576b4-9665-47bc-6f5e-08dc5edbc664"),
                            Name = "Power User",
                            NormalizedName = "POWER USER"
                        },
                        new
                        {
                            Id = new Guid("d35e0e83-9cdf-4819-6f5f-08dc5edbc664"),
                            Name = "VIP",
                            NormalizedName = "VIP"
                        });
                });
            ...
            modelBuilder.Entity("Stackoverflow.Domain.Entities.Comment", b =>
                {
                    b.HasOne("Stackoverflow.Domain.Entities.Post", null)
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Stackoverflow.Domain.Entities.PostAndComment", b =>
                {
                    b.HasOne("Stackoverflow.Domain.Entities.Comment", null)
                        .WithMany()
